...
here](https://github.com/gordielachance/tomahk-shortcodes/contributors)
= Notes =

For feature request and bug reports, [please use the
forums](http://wordpress.org/support/plugin/tomahk-shortcodes#postform).

If you are a plugin developer, [we would like to hear from
you](https://github.com/gordielachance/tomahk-shortcodes). Any contribution would be
very welcome.
